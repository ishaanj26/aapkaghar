        ...
        <div>
            ...
            <div className='flex flex-col gap-6 p-16 px-3 max-w-6xl mx-auto'>
                ...
                <div className='text-gray-400 text-xs sm:text-sm'>
                    Want to find a home? We are ready to help you find aapkaghar that suits your lifestyle and needs
                    <br />
                    We have a wide range of properties for you to choose from.
                </div>
                <Link
                    to={'/search'}
                    className='inline-block py-2 px-4 text-xs sm:text-sm text-white font-bold bg-black rounded w-fit'
                >
                    Get started...
                </Link>
            </div>
